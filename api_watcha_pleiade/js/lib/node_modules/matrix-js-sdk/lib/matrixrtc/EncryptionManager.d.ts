...
export declare class EncryptionManager implements IEncryptionManager {
    ...
    private joinConfig;
    private logger;
    constructor(userId: string, deviceId: string, getMemberships: () => CallMembership[], transport: IKeyTransport, statistics: Statistics, onEncryptionKeysChanged: (keyBin: Uint8Array<ArrayBufferLike>, encryptionKeyIndex: number, participantId: string) => void, parentLogger?: Logger);
    getEncryptionKeys(): Map<string, Array<{
        key: Uint8Array;
        timestamp: number;
    }>>;
