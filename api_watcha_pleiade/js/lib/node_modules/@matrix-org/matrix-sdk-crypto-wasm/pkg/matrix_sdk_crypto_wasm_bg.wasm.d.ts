...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h607bd7dfd48e12ce: (a: number, b: number) => void;
export const closure734_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6591bac8898b164c: (a: number, b: number) => void;
export const closure410_externref_shim: (a: number, b: number, c: any) => void;
export const closure422_externref_shim: (a: number, b: number, c: any, d: any) => void;
