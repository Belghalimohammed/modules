    ...
    attach: function (context, settings) {
      ...
      if (isFront && agendaEnabled) {
        once(
          ...
          // Inject spinner and container layout
          agendaEl.innerHTML =
              ...
              viewDidMount: function () {
                ...
                if (button) {
                  button.addEventListener("contextmenu", function (e) {
                    ...
                    window.open("/calendar", "_blank"); // open in new tab
                  });
                }
              },
              height:400,
          ...
          xhr.onabort = () => console.log("Requête AJAX annulée");
          xhr.ontimeout = () => console.log("Requête AJAX expirée");
          xhr.onloadend = () => {
            const button = document.querySelector(".fc-EventButton-button");
            if (button) {
